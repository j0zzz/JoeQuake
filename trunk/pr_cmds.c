...
This should be called when an object is spawned, and then
...
{
	int	i, j, k, l;
	float	*angles, bounds[2][3], xvector[2], yvector[2], a;
...
void PF_vectoangles (void)
{
	...
	{
		yaw = value1[0] ? (atan2(value1[1], value1[0]) * 180 / M_PI) : (value1[1] > 0) ? 90 : 270;
		if (yaw < 0)
			yaw += 360;
